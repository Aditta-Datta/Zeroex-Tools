...
app.get("/fake-ss-maker", (req, res) => res.sendFile(path.join(__dirname, "views", "fake-ss-maker.html")));
app.get("/fake-ss-maker/bkash", (req, res) => res.sendFile(path.join(__dirname, "views", "bkash-ss-maker.html")));
